...
```{r check-data-source, include = FALSE, eval = TRUE}
# Check if cached data is available (for pkgdown builds)
...
# If no cached data, use pkgdown's build mode
if (!cache_check() && Sys.getenv("PKGDOWN_BUILD") != "") {
  knitr::opts_chunk$set(eval = FALSE)
  message("NOTE: NC DPI data unavailable - building vignette in documentation-only mode")
}
```
