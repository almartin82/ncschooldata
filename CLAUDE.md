...
| Python tests | `pytest tests/test_pyncschooldata.py -v`                                       | Python wrapper works correctly                 |
...
system("pip install -e ./pyncschooldata && pytest tests/test_pyncschooldata.py -v")
...
warnings - \[ \] `pytest tests/test_pyncschooldata.py` — all tests
pass - \[ \]
